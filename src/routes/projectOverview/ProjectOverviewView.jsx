        ...
        <div className={cls}>
          ...
          <BasicCard className={`${cls}-warn-info`} name="实时报警信息">
            <div className="content">
              ...
              <div className="right">
                {warnDataHandle(SSBJ.info) ||
                  [].map((item, index) => <span key={index}>{item}</span>)}
              </div>
            </div>
          </BasicCard>
          <BasicCard
            className={`${cls}-behavior-management`}
            name="人员行为管理"
          >
          ...
          <BasicCard className={`${cls}-work-situation`} name="劳务情况">
            <div className="main">
              ...
              <RingEchart index="special-job" desc="特殊工种" data={TSGZ} />
          ...
          <BasicCard className={`${cls}-production`} name="工序状态管理">
            <div className="main">
              ...
              <div className="GXWT">
                ...
                <GXWTEchart index={"GXWT"} data={GXWTS} />
              </div>
              <div className="worker-problems">
                  ...
                  onClick={() => {
                    moreClick(
                      [
                        ...
                        { _key: "workstage", desc: "工序名", width: 60 },
                        { _key: "count", desc: "数量", width: 40 },
                      ],
                      GRWTS
                    );
                  }}
                ...
                >
                  更多
                  <Icon size="xs" color="#4ab4e8" type="right" />
                </div>
                <Table
                  kVMap={[
                    { _key: "name", desc: "姓名", width: 40 },
